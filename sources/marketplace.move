...
module move_marketplace::marketplace {
    ...
    public entry fun list<T: key + store, C>(
        ...
        // transfer the actual nft to be owned by the marketplace.
        // if marketplace is shared does that mean anyone can claim this nft? I don't think so but should look into it just incase.
        let child_ref = transfer::transfer_to_object(item, marketplace);
